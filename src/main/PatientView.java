...
public Locale getLocale(){
	...
	public void changeLanguage(Locale locale) {
		...
		bundle= ResourceBundle.getBundle("src.resources.MessageBundle");

		languageButton.setText(bundle.getString("French"));
		indivUserButton.setText(bundle.getString("Individual"));
		clinicButton.setText(bundle.getString("Clinic"));
		...
		viewDBButton.setText(bundle.getString("View whole DB"));
		CreatePatient.setText(bundle.getString("Input Image"));
		export.setText(bundle.getString("Export PDF"));
		createPatientButton.setText(bundle.getString("Create Patient"));
		updatePatientButton.setText(bundle.getString("Update Patient"));

		fNameLabel.setText(bundle.getString("First Name"));
		lNameLabel.setText(bundle.getString("Last Name"));
		medicareLabel.setText(bundle.getString("Medicare"));
		dobLabel.setText(bundle.getString("Date of Birth:"));
		dobYearLabel.setText(bundle.getString("year"));
		dobDayLabel.setText(bundle.getString("day"));
		dobMonthLabel.setText(bundle.getString("month"));
		address.setText(bundle.getString("Address"));
		emailAddress.setText(bundle.getString("Email"));
		createButton.setText(bundle.getString("Input Image"));
		searchButton.setText(bundle.getString("Search"));
		updateDBButton.setText(bundle.getString("Update DB"));
	}
